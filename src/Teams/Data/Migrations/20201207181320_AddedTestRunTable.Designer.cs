...
namespace Teams.Data.Migrations
{
    ...
    [Migration("20201207181320_AddedTestRunTable")]
    partial class AddedTestRunTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Teams.Models.Answer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TestRunFK")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("TestRunFK");
            ...
            modelBuilder.Entity("Teams.Domain.Test", b =>
                {
                    b.HasOne("Teams.Models.TestRun", null)
                        .WithMany("Tests")
            ...
            modelBuilder.Entity("Teams.Models.TestRun", b =>
                {
                    b.HasOne("Teams.Models.ApplicationUser", "TestedUser")
                        .WithMany("TestsTaken")
